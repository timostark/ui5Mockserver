...
function parseEntitySet(namespace: string, entitySet: any, entityType: any, entityTypes: Array<any>, annotations?: Array<Annotation>): EntitySet {
  return {
    namespace,
    name: entitySet['$']['Name'],
    addressable: entitySet['$']['sap:addressable'],
    creatable: entitySet['$']['sap:creatable'],
    deletable: entitySet['$']['sap:deletable'],
    pageable: entitySet['$']['sap:pageable'],
    updatable: entitySet['$']['sap:updatable'],
    ...
    xml2js.parseString(xml, (error, metadata) => {
      ...
      schemas.forEach(schema => {
        if (schema['EntityType']) {
          ...
          functions.push(...parseFunctions(entityContainer['FunctionImport']));
        }
